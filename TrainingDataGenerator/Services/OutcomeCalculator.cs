...
public class OutcomeCalculator : IOutcomeCalculator
{
    ...
    public OutcomeCalculator(ILogger logger, IRandomProvider random)
    {
        _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        _random = random ?? throw new ArgumentNullException(nameof(random));
    }

    public Encounter CalculateOutcome(Encounter encounter)
    {
        ...
        encounter.Outcome = CombatCalculator.CalculateCombatOutcome(encounter.PartyMembers, encounter.Monsters, totalPartyCombatPower, totalMonstersCombatPower, baseStatsParty, baseStatsMonsters, _logger);
